...
###
### Support for "verbatim" tag copyright 2007, VMware Incorporated.  (See
### below, two short sections delimited by
### "## Begin VMware-contributed code ##" and
### "## End VMware-contributed code ##".)
###
...
class HtmlHandler(xml.sax.handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        if name == 'br':
            ...
            if not self.iter.starts_line():
                self._insert_text("\n")
        ## Begin VMware-contributed code ##
        elif name == 'verbatim':
            self._insert_text(attrs['value'])
        elif name == 'tabs':
            self._insert_text('\t' * int(attrs['count']))
        ## End VMware-contributed code ##
        elif name == 'span':
            pass
        elif name == 'ul':
